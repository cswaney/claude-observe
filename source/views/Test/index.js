    ...
    <Box flexDirection="column">
      <Box borderStyle="single" borderColor="cyan" padding={1}>
        <Box flexDirection="column">
          ...
          <Text>If you see multiple boxes stacking, it's an Ink rendering problem.</Text>
          <Text>If you only see one box that updates, the rendering works correctly.</Text>
        </Box>
      </Box>
